"""SQLAlchemy mappings for authoritative control-plane state.

Runtime telemetry is intentionally excluded; only identity, intent, operations,
delivery bookkeeping, observations, and executor presence belong in PostgreSQL.
"""
...
# Provider catalog and desired state -------------------------------------------
...
# User intent, dispatch reliability, and reconciliation concurrency ------------
...
# Raw observations and derived health ------------------------------------------
